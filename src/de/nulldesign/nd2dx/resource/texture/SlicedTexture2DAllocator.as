package de.nulldesign.nd2dx.resource.texture 
{
	 ...
	 * @author Thomas John
	 */
	public class SlicedTexture2DAllocator extends ResourceAllocatorBase
	{
		public var atlasSlicedNode2D:SlicedTexture2D;
		...
		public function SlicedTexture2DAllocator(texture:Object, sliceLeft:Number = 0.2, sliceRight:Number = 0.8, sliceTop:Number = 0.2, sliceBottom:Number = 0.8, sliceType:int = TextureUtil.SLICE_TYPE_3_HORIZONTAL, freeLocalResourceAfterRemoteAllocation:Boolean = false) 
		{
		...
		override public function allocateLocalResource(assetGroup:AssetGroup = null, forceAllocation:Boolean = false):void 
		{
			...
			if ( texture )
			{
				...
				// to trigger update signal dispatcher
				atlasSlicedNode2D.isLocallyAllocated = false;
				atlasSlicedNode2D.isLocallyAllocated = true;
			}
			
			//if ( atlasSlicedNode2D.isLocallyAllocated && freeLocalResourceAfterRemoteAllocation ) freeLocalResource();
		}
		...
		override public function freeRemoteResource():void 
		{
			...
			atlasSlicedNode2D.isRemotelyAllocated = false;
		}
		...
		override public function set resource(value:ResourceBase):void 
		{
			...
			atlasSlicedNode2D = value as SlicedTexture2D;
		}
	}
