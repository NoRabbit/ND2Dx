	...
	public class TexturedMeshCloudRenderer extends RendererBase
	{
		...
		override public function drawTexturedMesh(texture:Texture2D, useTextureSize:Boolean, vertices:Vector.<Vertex3D>, indices:Vector.<uint>, parent:Node2D, node:Node2D = null, x:Number = 0.0, y:Number = 0.0, z:Number = 0.0, scaleX:Number = 1.0, scaleY:Number = 1.0, scaleZ:Number = 1.0, rotationZ:Number = 0.0, rotationY:Number = 0.0, rotationX:Number = 0.0, r:Number = 1.0, g:Number = 1.0, b:Number = 1.0, a:Number = 1.0, uvOffsetX:Number = 0.0, uvOffsetY:Number = 0.0, uvScaleX:Number = 1.0, uvScaleY:Number = 1.0, blendModeSrc:String = "one", blendModeDst:String = "oneMinusSourceAlpha", pivotX:Number = 0.0, pivotY:Number = 0.0):void 
		{
			...
			for (; i < n; i++) 
			{
				...
				ND2DX::USE_DOMAIN_MEMORY_BATCHING
				{
					...
					sf32(r * vertex.r, int(vertexBufferIndex + 16));
					sf32(g * vertex.g, int(vertexBufferIndex + 20));
					sf32(b * vertex.b, int(vertexBufferIndex + 24));
					sf32(a * vertex.a, int(vertexBufferIndex + 28));
				...
				{
					// set data to vector
					vVertexBuffer[int(vertexBufferIndex)] = parentWorldModelMatrix_00 * v1x_prep + parentWorldModelMatrix_10 * v1y_prep + parentWorldModelMatrix_30;
					vVertexBuffer[int(vertexBufferIndex + 1)] = parentWorldModelMatrix_01 * v1x_prep + parentWorldModelMatrix_11 * v1y_prep + parentWorldModelMatrix_31;
					
					vVertexBuffer[int(vertexBufferIndex + 2)] = uv1x * uvScaleX + uvOffsetX;
					vVertexBuffer[int(vertexBufferIndex + 3)] = uv1y * uvScaleY + uvOffsetY;
					
					vVertexBuffer[int(vertexBufferIndex + 4)] = r * vertex.r;
					vVertexBuffer[int(vertexBufferIndex + 5)] = g * vertex.g;
					vVertexBuffer[int(vertexBufferIndex + 6)] = b * vertex.b;
					vVertexBuffer[int(vertexBufferIndex + 7)] = a * vertex.a;
		...
		override public function drawTexturedQuad(texture:Texture2D, useTextureSize:Boolean, parent:Node2D, node:Node2D = null, x:Number = 0.0, y:Number = 0.0, z:Number = 0.0, scaleX:Number = 1.0, scaleY:Number = 1.0, scaleZ:Number = 1.0, rotationZ:Number = 0.0, rotationY:Number = 0.0, rotationX:Number = 0.0, r:Number = 1.0, g:Number = 1.0, b:Number = 1.0, a:Number = 1.0, uvOffsetX:Number = 0.0, uvOffsetY:Number = 0.0, uvScaleX:Number = 1.0, uvScaleY:Number = 1.0, blendModeSrc:String = "one", blendModeDst:String = "oneMinusSourceAlpha", pivotX:Number = 0.0, pivotY:Number = 0.0):void 
		{
			...
			ND2DX::USE_VECTOR_BATCHING
			{
				...
				vVertexBuffer[int(vertexBufferIndex + 4)] = r;
				vVertexBuffer[int(vertexBufferIndex + 5)] = g;
				vVertexBuffer[int(vertexBufferIndex + 6)] = b;
				vVertexBuffer[int(vertexBufferIndex + 7)] = a;
				
				// v2
				
				vVertexBuffer[int(vertexBufferIndex + 8)] = parentWorldModelMatrix_00 * v2x_prep + parentWorldModelMatrix_10 * v2y_prep + parentWorldModelMatrix_30;
				vVertexBuffer[int(vertexBufferIndex + 9)] = parentWorldModelMatrix_01 * v2x_prep + parentWorldModelMatrix_11 * v2y_prep + parentWorldModelMatrix_31;
				
				vVertexBuffer[int(vertexBufferIndex + 10)] = uv2x * uvScaleX + uvOffsetX;
				vVertexBuffer[int(vertexBufferIndex + 11)] = uv2y * uvScaleY + uvOffsetY;
				
				vVertexBuffer[int(vertexBufferIndex + 12)] = r;
				vVertexBuffer[int(vertexBufferIndex + 13)] = g;
				vVertexBuffer[int(vertexBufferIndex + 14)] = b;
				vVertexBuffer[int(vertexBufferIndex + 15)] = a;
				
				// v3
				
				vVertexBuffer[int(vertexBufferIndex + 16)] = parentWorldModelMatrix_00 * v3x_prep + parentWorldModelMatrix_10 * v3y_prep + parentWorldModelMatrix_30;
				vVertexBuffer[int(vertexBufferIndex + 17)] = parentWorldModelMatrix_01 * v3x_prep + parentWorldModelMatrix_11 * v3y_prep + parentWorldModelMatrix_31;
				
				vVertexBuffer[int(vertexBufferIndex + 18)] = uv3x * uvScaleX + uvOffsetX;
				vVertexBuffer[int(vertexBufferIndex + 19)] = uv3y * uvScaleY + uvOffsetY;
				
				vVertexBuffer[int(vertexBufferIndex + 20)] = r;
				vVertexBuffer[int(vertexBufferIndex + 21)] = g;
				vVertexBuffer[int(vertexBufferIndex + 22)] = b;
				vVertexBuffer[int(vertexBufferIndex + 23)] = a;
				
				// v4
				
				vVertexBuffer[int(vertexBufferIndex + 24)] = parentWorldModelMatrix_00 * v4x_prep + parentWorldModelMatrix_10 * v4y_prep + parentWorldModelMatrix_30;
				vVertexBuffer[int(vertexBufferIndex + 25)] = parentWorldModelMatrix_01 * v4x_prep + parentWorldModelMatrix_11 * v4y_prep + parentWorldModelMatrix_31;
				
				vVertexBuffer[int(vertexBufferIndex + 26)] = uv4x * uvScaleX + uvOffsetX;
				vVertexBuffer[int(vertexBufferIndex + 27)] = uv4y * uvScaleY + uvOffsetY;
				
				vVertexBuffer[int(vertexBufferIndex + 28)] = r;
				vVertexBuffer[int(vertexBufferIndex + 29)] = g;
				vVertexBuffer[int(vertexBufferIndex + 30)] = b;
				vVertexBuffer[int(vertexBufferIndex + 31)] = a;
